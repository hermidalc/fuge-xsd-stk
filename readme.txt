    ...
    that a model called 'fugexsd' has been created within your Magic Draw model.
    
    Important: before launching AndroMDA, be sure to have exported your model.

    /fugexsd J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Allyson Lister\.m2\repository\fugexsd\

        (*nix)
        /home/Allyson Lister/.maven/repository/fugexsd/
